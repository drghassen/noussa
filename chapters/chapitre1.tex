...
\label{sec13}
%=====================================%
IPANEMA (\textbf{I}nternational \textbf{P}artners \textbf{N}etwork \& \textbf{M}anagement) est une solution 
...
\begin{figure}[!ht]
\centering
\roundedfullwidthimage{cover/figures/archii_avant_apres.png}
